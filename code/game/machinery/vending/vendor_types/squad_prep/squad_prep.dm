...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/populate_product_list(scale)
	listed_products = list(
		...
		list("Lightweight IMP Backpack", floor(scale * 15), /obj/item/storage/backpack/marine/imp, VENDOR_ITEM_REGULAR),
		...
		list("USCM Double Deuce Patch", round(scale * 15), /obj/item/clothing/accessory/patch/deuce, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/squad/populate_product_list(scale)
	listed_products = list(
		...
		list("FLARES AND LIGHT", -1, null, null),
		...
		list("M89-S Signal Flare Pack", round(scale * 1.5), /obj/item/storage/box/flare/signal, VENDOR_ITEM_REGULAR),
		list("M90-A Signal Flare Pack", round(scale * 1), /obj/item/storage/box/flare/signal_violet, VENDOR_ITEM_REGULAR),
